...
import { TouchableOpacity, StyleSheet, Platform, Linking, NativeModules } from 'react-native';
...
class AIBNativeAd extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <CachedImage style={styles.banner} source={{ uri: this.state.ad.banner }} resizeMode={'contain'} />
      </TouchableOpacity>
    );
  }
}
